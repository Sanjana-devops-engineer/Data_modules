locals {
  ...
  db_subnet_group_name    = local.create_db_subnet_group ? var.db_subnet_group_name : null

  create_db_parameter_group = var.create_db_parameter_group
  parameter_group_name_id = local.create_db_parameter_group ? var.parameter_group_name : null

  create_db_option_group = var.create_db_option_group && var.db_engine != "postgres"
  option_group           = local.create_db_option_group ? var.option_group_name : null
}
